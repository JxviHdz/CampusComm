    ...
    return (
        <>
            {index ?
                ...
                :
                <p>El usuario no tiene listados. Lo siento</p>
            }
        </>
    )
}
...
function Buyers(props)
{
    ...
    return (
        <>
            <p>Interesados en {listingName}:</p>
            <>{buyers.map(buyer => {
                ...
                return (
                    <>
                        ...
                        </Link>: <button onClick={SendOffer}>Aceptar oferta</button></>
                        <br/>
                    </>
                )
            })}</>
                            ...
                            <>Cuenta eliminada</>
                                ...
                                <>{review.reviewDescr} - {review.stars} stars {
                                    review.senderID == userID ?
                                        <>
                                            <button onClick={editReview}>Editar reseña</button>
                                        </>
                                        :
                                        <></>
                                }
